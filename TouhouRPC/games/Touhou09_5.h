...
public:
	...
	std::string formatScore(int score); // Score formatter
...
private:
	...
	enum address {
		...
		MENU_DATA_FIRST_SCORE_OFFSET = 0x470, // Highest socre on Level 1 - Scene 1
		MENU_DATA_NEXT_SCORE_OFFSET_ADD = 0x60, // Offset to add to point to the next highest socre in memory (done in a loop.)
												...
												// Addition of all socres gives the combined photo score.
