...
Touhou15::Touhou15(PROCESSENTRY32W const& pe32) : TouhouMainGameBase(pe32)
{
}
...
std::string Touhou15::getStageName() const
{
	if (stage <= 6)
	{
...
std::string const& Touhou15::getBGMName() const
{
...
{
	TouhouMainGameBase::setSmallImageInfo(icon, text);
