...
class Touhou15 : public TouhouBase {
public:
...
private:
    enum address {
        ...
        PRACTICE_SELECT_FLAG = 0x004E7794L, // is set to 16 when practice selected, 32 when spell practice selected, 256 when Pointdevice mode selected, and 0 otherwise, on main menu.
        BGM_STR = 0x00520224L,
    };
};
